  ...
  groups: [
    {
      ...
      name: 'East Division',
      teams: [
        { id: 'pll-atlas', name: 'New York Atlas', shortName: 'Atlas', flag: '🗽', group: 'east', seed: 3, record: '4-2' },
        { id: 'pll-cannons', name: 'Boston Cannons', shortName: 'Cannons', flag: '💥', group: 'east', seed: 6, record: '1-5' },
        { id: 'pll-waterdogs', name: 'Philadelphia Waterdogs', shortName: 'Waterdogs', flag: '🐕', group: 'east', seed: 7, record: '2-4' },
        { id: 'pll-redwoods', name: 'DC Redwoods', shortName: 'Redwoods', flag: '🌲', group: 'east', seed: 8, record: '1-5' },
      ],
    },
    {
      id: 'west',
      name: 'West Division',
      teams: [
        { id: 'pll-outlaws', name: 'Denver Outlaws', shortName: 'Outlaws', flag: '🐎', group: 'west', seed: 1, record: '5-1' },
        { id: 'pll-archers', name: 'Utah Archers', shortName: 'Archers', flag: '🏹', group: 'west', seed: 2, record: '3-3' },
        { id: 'pll-whipsnakes', name: 'Maryland Whipsnakes', shortName: 'Whipsnakes', flag: '🐍', group: 'west', seed: 4, record: '3-2' },
        { id: 'pll-chaos', name: 'Carolina Chaos', shortName: 'Chaos', flag: '🌪️', group: 'west', seed: 5, record: '2-4' },
      ],
    },
  ],
  knockoutMatches: [
  ...
  groups: [
    {
      ...
      name: 'WLL Teams',
      teams: [
        { id: 'wll-guard', name: 'Boston Guard', shortName: 'Guard', flag: '🛡️', group: 'wll', seed: 1, record: '0-1' },
        { id: 'wll-charging', name: 'New York Charging', shortName: 'Charging', flag: '⚡', group: 'wll', seed: 2, record: '1-0' },
        { id: 'wll-charm', name: 'Maryland Charm', shortName: 'Charm', flag: '🦀', group: 'wll', seed: 3, record: '0-0' },
        { id: 'wll-palms', name: 'California Palms', shortName: 'Palms', flag: '🌴', group: 'wll', seed: 4, record: '0-0' },
      ],
    },
  ],
  knockoutMatches: [
